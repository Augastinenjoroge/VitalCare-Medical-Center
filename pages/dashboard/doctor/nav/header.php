...
if (isset($_SESSION['user_id']) && isset($_SESSION['role_id']) && $_SESSION['role_id'] == 2) { // Assuming role_id 2 is for Doctor
    ...
    $sql = "SELECT FirstName, LastName FROM Doctors WHERE UserID = ?";
            ...
            <nav id="sidebar">
                <div class="sidebar_blog_1">
                    ...
                    <div class="sidebar_user_info">
                        ...
                        <div class="user_profle_side">
                            ...
                            <div class="user_info">
                                <h6>Dr.<?php echo htmlspecialchars($firstName); ?></h6>
                ...
                <div class="sidebar_blog_2">
                    ...
                    <ul class="list-unstyled components">
                        ...
                        <li>
                            <a href="appointment.php"><i class="fa fa-briefcase blue1_color"></i>
                                <span>Appointment</span></a>
                        </li>
                        <li>
                            <a href="list_patients.php"><i class="fa fa-users green_color"></i>
                                    ...
                                    <ul class="user_profile_dd">
                                        <li>
                                            <a class="dropdown-toggle" data-toggle="dropdown">
                                                ...
                                                <span class="name_user">Dr. <?php echo htmlspecialchars($firstName . ' ' . $lastName); ?></span>
                                            </a>
